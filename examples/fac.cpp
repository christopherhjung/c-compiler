...
int main(int argc, char **argv) {
  ...
  Value *ValN = Builder.CreateLoad(ArgVarNPtr, "while-cond-n-load");
  ...
  Value *OldXVal = Builder.CreateLoad(LocalVarXPtr);

  /* Load the value of n at the beginning of a loop iteration */
  Value *OldNVal = Builder.CreateLoad(ArgVarNPtr);
  ...
  Value *OldNValReload = Builder.CreateLoad(ArgVarNPtr);
  ...
  Value *FinalXVal = Builder.CreateLoad(LocalVarXPtr);
