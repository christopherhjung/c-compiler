...
public:
    ...
    LexerGrammarEntry(const std::string &name, const std::string &regex, bool greedy, bool hide, bool catchValue)
            : name(name), regex(regex), greedy(greedy), hide(hide), catchValue(catchValue) {
